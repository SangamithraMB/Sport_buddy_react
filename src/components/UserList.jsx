...
function UserList() {
  ...
  return (
    <div className="p-8 bg-gray-100 min-h-screen">
      {selectedUser ? (
        // Render Chat component when a user is selected
        <div>
          <button
          ...
          {/* Generate roomId dynamically using the IDs of both users */}
          <Chat 
          ...
          {loading ? (
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {users.map((u) => (
                ...
                >
                  <h3 className="text-xl font-medium text-gray-800">{u.first_name} {u.last_name}</h3>
