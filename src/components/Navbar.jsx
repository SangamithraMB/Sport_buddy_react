      ...
      <nav className="fixed top-0 left-0 w-full bg-blue-600 text-white p-4 shadow-lg z-50">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <ul className="flex space-x-6">
            ...
            {user ? (
              <>
                <li><Link to="/open-playdates" className="hover:text-gray-300">Open Playdates</Link></li>
                <li><Link to="/playdates" className="hover:text-gray-300">Create Playdate</Link></li>
                <li>
              ...
              <>
                ...
                <li><Link to="/add-user" className="hover:text-gray-300">Sign-Up</Link></li>
              </>
            )}
          </ul>
        </div>
